...
<div class="sm:p-6 mb-4">
    <h1 class="text-2xl md:text-3xl text-black font-bold mb-1">PKL</h1>
</div>

<div class="grid grid-cols-5 gap-4 p-6">
    <div class="text-sm md:text-2xl text-black font-bold mb-1">Riwayat PKL</div>
    <div class="place-self-center col-start-3 px-5 w-auto h-auto font-bold text-white bg-gray-500 rounded-full">
        <a href="/buat/pkl">Input PKL</a>
    </div>
</div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                ...
                                <tr>
                                    <td class="px-4 py-4 text-sm font-medium text-gray-700 dark:text-gray-200 whitespace-nowrap">
                                        <span>{{ $pkl->created_at->format('d-m-Y') }}</span>
                                    </td>
                                    
                                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                        <div class="flex items-center gap-x-2">
                                            <div>
                                                <h2 class="text-sm font-medium text-gray-800 dark:text-white ">{{ $pkl->semester }}</h2>
                                            </div>
                                        </div>
                                    </td>
