...
<div class="sm:p-6 mb-4">
    <h1 class="text-2xl md:text-3xl text-black font-bold mb-1">Skripsi</h1>
</div>

<div class="grid grid-cols-5 gap-4 p-6">
    <div class="text-sm md:text-2xl text-black font-bold mb-1">Riwayat Skripsi</div>
    <div class="place-self-center col-start-3 px-5 w-auto h-auto font-bold text-white bg-gray-500 rounded-full">
        <a href="/buat/skripsi">Input Skripsi</a>
    </div>
</div>
