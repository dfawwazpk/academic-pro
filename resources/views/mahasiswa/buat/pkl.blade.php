    ...
    <div class="grid grid-cols-3 grid-rows-3 p-10">
        {{-- <div class="row-start-1 col-span-2 font-bold">Status
            <div class="grid w-[28rem] grid-cols-3 gap-2 rounded-xl bg-gray-200 p-2">
                <div>
                    <input type="radio" name="status_pkl" id="1" value="Belum" class="peer hidden" disabled />
                ...
                <div>
                    <input type="radio" name="status_pkl" id="2" value="Sedang" class="peer hidden" disabled />
                ...
                <div>
                    <input type="radio" name="status_pkl" id="3" value="Lulus" class="peer hidden" checked />
        ...
        <div class="row-start-4 col-start-2 place-self-center">
