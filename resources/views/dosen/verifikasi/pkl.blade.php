                        ...
                        @foreach ($mahasiswaList as $mahasiswa)
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    ...
                                    <a href ="/verifikasi/pkl/tolak/{{ $pkl->id }}" class="px-4 py-4 text-sm font-medium text-gray-700 bg-gray-500 hover:bg-red-600 rounded-full whitespace-nowrap" style="width: 100px;">
                                        <div class="inline-flex items-center gap-x-2">
