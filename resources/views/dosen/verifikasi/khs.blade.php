...
<div class="relative bg-indigo-200 dark:bg-indigo-500 p-7 sm:p-7 rounded-sm overflow-hidden mb-10 mt-10">
    <h1 class="text-2xl md:text-3xl text-slate-800 dark:text-slate-100 font-bold mb-1">Verifikasi KHS {{-- {{ Auth::user()->name }} --}} </h1>
                        ...
                        @foreach ($mahasiswaList as $mahasiswa)
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    ...
                                    <a href ="/verifikasi/khs/tolak/{{ $khs->id }}" class="px-4 py-4 text-sm font-medium text-gray-700 bg-gray-500 hover:bg-emerald-600 rounded-full whitespace-nowrap" style="width: 100px;">
                                        <div class="inline-flex items-center gap-x-2">
