                            ...
                            <tr>
                                <th scope="col" class="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    <div class="flex items-center justify-center gap-x-3">
                                        <a href="/rekap/skripsi/2016/sudah"class="flex items-center">
                                            <span>Sudah</span>
                                        </a>
                                    </div>
                                </th>
                                <th class="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    <div class="flex items-center justify-center">
                                        <a href="/rekap/skripsi/2016/belum"class="flex items-center">
                                            <span>Belum</span>
                                        </a>
                                    </div>
                                </th>
                                <th scope="col" class="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    <div class="flex items-center gap-x-3">
                                        <a href="/rekap/skripsi/2017/sudah"class="flex items-center">
                                            <span>Sudah</span>
                                        </a>
                                    </div>
                                </th>
                                <th class="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    <div class="flex items-center justify-center">
                                        <a href="/rekap/skripsi/2017/belum"class="flex items-center">
                                            <span>Belum</span>
                                        </a>
                                    </div>
                                </th>
                                <th scope="col" class="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    <div class="flex items-center justify-center gap-x-3">
                                        <a href="/rekap/skripsi/2018/sudah"class="flex items-center">
                                            <span>Sudah</span>
                                        </a>
                                    </div>
                                </th>
                                <th class="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    <div class="flex items-center justify-center">
                                        <a href="/rekap/skripsi/2018/belum"class="flex items-center">
                                            <span>Belum</span>
                                        </a>
                                    </div>
                                </th>
                                <th scope="col" class="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    <div class="flex items-center justify-center gap-x-3">
                                        <a href="/rekap/skripsi/2019/sudah"class="flex items-center">
                                            <span>Sudah</span>
                                        </a>
                                    </div>
                                </th>
                                <th class="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    <div class="flex items-center justify-center">
                                        <a href="/rekap/skripsi/2019/belum"class="flex items-center">
                                            <span>Belum</span>
                                        </a>
                                    </div>
                                </th>
                                <th scope="col" class="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    <div class="flex items-center justify-center gap-x-3">
                                        <a href="/rekap/skripsi/2020/sudah"class="flex items-center">
                                            <span>Sudah</span>
                                        </a>
                                    </div>
                                </th>
                                <th class="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    <div class="flex items-center justify-center">
                                        <a href="/rekap/skripsi/2020/belum"class="flex items-center">
                                            <span>Belum</span>
                                        </a>
                                    </div>
                                </th>
                                <th scope="col" class="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    <div class="flex items-center justify-center gap-x-3">
                                        <a href="/rekap/skripsi/2021/sudah"class="flex items-center">
                                            <span>Sudah</span>
                                        </a>
                                    </div>
                                </th>
                                <th class="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    <div class="flex items-center justify-center">
                                        <a href="/rekap/skripsi/2021/belum"class="flex items-center">
                                            <span>Belum</span>
                                        </a>
                                    </div>
                                </th>
                                <th scope="col" class="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    <div class="flex items-center justify-center gap-x-3">
                                        <a href="/rekap/skripsi/2022/sudah"class="flex items-center">
                                            <span>Sudah</span>
                                        </a>
                                    </div>
                                </th>
                                <th class="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    <div class="flex items-center justify-center">
                                        <a href="/rekap/skripsi/2022/belum"class="flex items-center">
                                            <span>Belum</span>
                                        </a>
                                    </div>
                                </th>
                                <th scope="col" class="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    <div class="flex items-center justify-center gap-x-3">
                                        <a href="/rekap/skripsi/2023/sudah"class="flex items-center">
                                            <span>Sudah</span>
                                        </a>
                                    </div>
                                </th>
                                <th class="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    <div class="flex items-center justify-center">
                                        <a href="/rekap/skripsi/2023/belum"class="flex items-center">
                                            <span>Belum</span>
                                        </a>
                                    </div>
                                </th>
    ...
    <div class="grid grid-cols-4 mt-4 mb-4">
        <div class="col-start-4">
            <div class="grid grid-cols-2 gap-2">
                <a href="/rekap/skripsi/cetak" target="_blank" class="btn btn-xs btn-neutral rounded-full col-start-2">Cetak</a>
            </div>
        </div>
    </div>
...
<section class="container px-4 mx-auto">
    ...
    <div class="grid grid-cols-4 mt-4 mb-4">
        <div class="col-start-4">
            <div class="grid grid-cols-2 gap-2">
                <a href="/rekap/skripsi/{{ $angkatanSelected }}/{{ $statusSkripsi }}/cetak" target="_blank" class="btn btn-xs btn-neutral rounded-full col-start-2">Cetak</a>
            </div>
        </div>
    </div>
